...
export function OnlineNotepadClient() {
  ...
  const internalLinks = [
    { href: "/share-notes-online-without-login", label: "Share Notes Without Login" },
    { href: "/online-notepad-with-shareable-link", label: "Notepad with Share Link" },
    { href: "/share-text-between-devices", label: "Share Text Between Devices" },
    ...
    <div className="min-h-screen bg-background text-foreground relative selection:bg-primary/30 overflow-x-hidden">
      ...
      <section className="relative max-w-5xl mx-auto px-4 pt-16 pb-20 sm:px-6 lg:px-8 text-center z-10 space-y-6">
        ...
        <p className="text-lg sm:text-xl text-zinc-500 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
          Woff Space is the fastest way to write, save, and share text notes online.<br className="hidden sm:block" />
          Create a private, secure space in one click with zero sign-up required.
        </p>
      ...
      <section className="relative max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8 z-10 border-t border-zinc-200/50 dark:border-white/[0.04]">
        <div className="text-center space-y-3 mb-12">
          ...
          <p className="text-sm text-muted-foreground">Share notes in three simple steps.</p>
        </div>
        ...
        <div className="grid gap-8 sm:grid-cols-3">
          <div className="border border-zinc-200 dark:border-zinc-800/80 bg-white/50 dark:bg-zinc-950/40 p-6 rounded-2xl shadow-sm text-center space-y-3">
            <div className="h-12 w-12 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500 mx-auto font-bold text-lg">1</div>
            <h3 className="font-bold text-lg">Create notepad</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">Click to launch a brand new empty room immediately.</p>
          </div>
          <div className="border border-zinc-200 dark:border-zinc-800/80 bg-white/50 dark:bg-zinc-950/40 p-6 rounded-2xl shadow-sm text-center space-y-3">
            <div className="h-12 w-12 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500 mx-auto font-bold text-lg">2</div>
            <h3 className="font-bold text-lg">Write your note</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">Type, format notes, drop code, or upload files directly.</p>
          </div>
          <div className="border border-zinc-200 dark:border-zinc-800/80 bg-white/50 dark:bg-zinc-950/40 p-6 rounded-2xl shadow-sm text-center space-y-3">
            <div className="h-12 w-12 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500 mx-auto font-bold text-lg">3</div>
            <h3 className="font-bold text-lg">Share link</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">Copy the dynamic URL and send it to anyone, anywhere.</p>
          </div>
        </div>
      </section>
      ...
      <section className="relative max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8 z-10 border-t border-zinc-200/50 dark:border-white/[0.04]">
        <div className="text-center space-y-3 mb-12">
          ...
          <p className="text-sm text-muted-foreground">Perfect tool for fast and seamless sharing.</p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-4">
          <div className="border border-zinc-200 dark:border-zinc-800/80 bg-white/60 dark:bg-zinc-900/40 p-5 rounded-xl shadow-sm space-y-2.5">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">Share action items, decisions, and agendas with your remote team instantly.</p>
          </div>
          <div className="border border-zinc-200 dark:border-zinc-800/80 bg-white/60 dark:bg-zinc-900/40 p-5 rounded-xl shadow-sm space-y-2.5">
            <Terminal className="w-5 h-5 text-orange-500" />
            <h4 className="font-bold text-base">Code Snippets</h4>
            <p className="text-xs text-muted-foreground leading-relaxed">Send JSON, SQL, or component codes with teammates, styled with exact formatting.</p>
          </div>
          <div className="border border-zinc-200 dark:border-zinc-800/80 bg-white/60 dark:bg-zinc-900/40 p-5 rounded-xl shadow-sm space-y-2.5">
            <Laptop className="w-5 h-5 text-orange-500" />
            <h4 className="font-bold text-base">Transfer Text</h4>
            <p className="text-xs text-muted-foreground leading-relaxed">Move clipboard links, captions, and texts between your phone and laptop in seconds.</p>
          </div>
          <div className="border border-zinc-200 dark:border-zinc-800/80 bg-white/60 dark:bg-zinc-900/40 p-5 rounded-xl shadow-sm space-y-2.5">
            <FileText className="w-5 h-5 text-orange-500" />
            <h4 className="font-bold text-base">Study Topics</h4>
            <p className="text-xs text-muted-foreground leading-relaxed">Distribute exam notes, lists, reference sites, and PDFs with study groups quickly.</p>
          </div>
        </div>
      </section>
      ...
      <section className="relative max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8 z-10 border-t border-zinc-200/50 dark:border-white/[0.04]">
        <div className="text-center space-y-3 mb-12">
          ...
          <p className="text-sm text-muted-foreground">Minimalist utilities built for absolute performance.</p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          <div className="flex gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">Skip the verification steps. Open the page and share instantly.</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="h-10 w-10 rounded-lg bg-orange-500/10 flex items-center justify-center text-orange-500 shrink-0">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">Generates clean URL routes instantly that look great on any platform.</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="h-10 w-10 rounded-lg bg-orange-500/10 flex items-center justify-center text-orange-500 shrink-0">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">Open on phone, tablet or desktop. Updates instantly in real-time.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Privacy Banner */}
      <section className="relative max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8 z-10">
        <div className="border border-red-500/10 bg-red-500/5 dark:bg-red-500/10 rounded-2xl p-6 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
          <div className="h-10 w-10 rounded-xl bg-red-500/15 flex items-center justify-center text-red-500 shrink-0">
            <Lock className="w-5 h-5" />
          </div>
          <div className="space-y-0.5">
            <h4 className="font-bold text-foreground">Strict Privacy & No Indexing</h4>
            <p className="text-xs text-muted-foreground leading-relaxed">
              We do not index shared user spaces by default. Your content stays private and accessible only to people you send the link to. Storage is auto-cleaned after inactivity.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative max-w-3xl mx-auto px-4 py-16 sm:px-6 lg:px-8 z-10 border-t border-zinc-200/50 dark:border-white/[0.04]">
        <div className="text-center space-y-3 mb-10">
          ...
          <p className="text-sm text-muted-foreground">Answers to common questions about Woff Space.</p>
        </div>
      ...
      <section className="relative max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8 z-10 border-t border-zinc-200/50 dark:border-white/[0.04]">
        <div className="text-center mb-6">
          <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Related Sharing Utilities</h4>
        </div>
